...
package de.hf.marketdataprovider.osgicli;
...
public class OsgiBootstrapper {
    public static void main(String[] args) {
        ...
        try {
            ...
            Framework fwk = FrameworkUtil.CreateFramework(OsgiBootstrapper.class,activators,configuration,factory);
