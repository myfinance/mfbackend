...
public class RouteContextBuilderImpl implements RouteContextBuilder {
    ...
    public static final Logger LOG = LoggerFactory.getLogger(RouteContextBuilderImpl.class);

    @Override
    public ApplicationRouteContext build(String contextID, ClassLoader messageJaxbClassLoaders, RouteBuilder... providers){
        ...
        if (result == null) {
            ...
            try{
                ...
                LOG.error("unable to build CamelRootContext:"+e);
            }
