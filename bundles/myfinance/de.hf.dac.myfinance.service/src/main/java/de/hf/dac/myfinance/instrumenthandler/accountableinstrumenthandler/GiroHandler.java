...
public class GiroHandler extends AbsCashInstrumentHandler {
    ...
    public GiroHandler(InstrumentDao instrumentDao, AuditService auditService, ValueService valueService, RecurrentTransactionDao recurrentTransactionDao, String description, int tenantId, String businesskey) {
        super(instrumentDao, auditService, valueService, recurrentTransactionDao, description, tenantId, true, businesskey);
    }

    public GiroHandler(InstrumentDao instrumentDao, AuditService auditService, ValueService valueService, RecurrentTransactionDao recurrentTransactionDao, Instrument giro) {
        super(instrumentDao, auditService, valueService, recurrentTransactionDao, giro);
    }

    public GiroHandler(InstrumentDao instrumentDao, AuditService auditService, ValueService valueService, RecurrentTransactionDao recurrentTransactionDao, int instrumentId) {
