...
import de.hf.dac.myfinance.application.MFSecurityApplicationContextModule;
...
public class SecurityServiceBuilderImpl implements SecurityServiceBuilder {
    ...
    public RootSecurityProvider<OpType, OpLevel> build(String env) {
        ...
        MFSecurityApplicationContextModule mdSecurityApplicationContextModule
            = new MFSecurityApplicationContextModule(env,envService,emfb);
