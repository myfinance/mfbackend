 ...
 *  Project     : dac
 *
 *  File        : MyFinanceRunnerService.java
 *
 *  Author(s)   : hf
 *
 *  Created     : 20.02.2017
...
import de.hf.dac.myfinance.restservice.myfinanceresources.MyFinanceRunnerResource;
...
@Path("/Runner")
@Api(value = "MyFinanceRunner") //must start with capital letter for client generation
public class MyFinanceRunnerService extends TopLevelSecuredResource<OpType,OpLevel> {
    ...
    public MyFinanceRunnerResource getJobTypeRunner(@PathParam("jobtype") @ApiParam(name = "jobtype", value = "launching md jobs z.b. de.hf.dac.myfinance.importer.Import") String jobtype) {
        audit();
        // create RunnerResource
        return new MyFinanceRunnerResource(root.getMDRunnerJobTypeContext(jobtype));
    }
