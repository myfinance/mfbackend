...
public @interface RESTApplicationConfiguration {
    ...
    String corsAllowedOrigins() default "http://localhost:4300,http://localhost:4200,http://localhost:8080,http://fe.myfinance.mylocaldomain/mff,https://babcom.myds.me,*";
