...
import de.hf.dac.myfinance.restapi.exceptions.ServiceExceptionMapper;
...
@Designate(ocd = ApiApplicationConfiguration.class)
@Component(
    service = ApiApplication.class,
    name = "MF.RestApplicationService",
    immediate = true
)
public class ApiApplication {
    ...
    @Activate
    protected void activate(ApiApplicationConfiguration RESTApplicationConfiguration) {
        JAXRSServerFactoryBean sf = new JAXRSServerFactoryBean();
        sf.setResourceClasses(
            DefaultApiServiceImpl.class);
