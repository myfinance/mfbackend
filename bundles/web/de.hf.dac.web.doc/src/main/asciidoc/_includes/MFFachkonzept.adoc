 ...
 * incomeBudget: Einem Account(ancestor) kann genau ein incomeBudget zugewiesen werden. Jedes Budget darf mehrfach mit diesem Edgetype vorkommen (als descendant) wird verwendet als StandardBudget zur Verbuchung von regelmäßigen Einnahmen z.B. Loan
