...
der Wert mancher Accounts hängt am Wertwerkt oder anderen Faktoren. Damit dieser Wert in die Budgetierung eingeht muss er einem Budget zugewiesen werden.
...
Annuitätenkredit wie z.b. Kapilendo mit regelmäßigen Zins und Tilgungszahlungen. Dabei ist die Rate=zins+Tilgung fix
...
Kapilendo verkauft im Prinzip Anuitätenkredite von Firmen. Diese AnnuityLoans haben keinen Marktpreis. Sie verhalten sich wie ein Loan mit umgekehrten Besitzverhältnissen
